...
from ansible_collections.cisco.ios.plugins.modules import _ios_vlan
from ansible_collections.cisco.ios.plugins.modules._ios_vlan import parse_vlan_brief
...
class TestIosVlanModule(TestIosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.cisco.ios.plugins.modules._ios_vlan.run_commands')
        self.run_commands = self.mock_run_commands.start()

        self.mock_load_config = patch('ansible_collections.cisco.ios.plugins.modules._ios_vlan.load_config')
