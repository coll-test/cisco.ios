...
from ansible_collections.cisco.ios.plugins.module_utils.network.ios.utils.utils import get_interface_type
from ansible_collections.cisco.ios.plugins.module_utils.network.ios.argspec.acl_interfaces.acl_interfaces import Acl_InterfacesArgs
