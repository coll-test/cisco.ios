...
from ansible_collections.cisco.ios.plugins.module_utils.network.ios.utils.utils import netmask_to_cidr
from ansible_collections.cisco.ios.plugins.module_utils.network.ios.argspec.static_routes.static_routes import Static_RoutesArgs
